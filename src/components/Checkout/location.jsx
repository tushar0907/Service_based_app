          ...
          <div
            ...
            className={`flex ${
              selectedAddress === address.id
                ? "bg-black text-white"
                : "text-black"
            } cursor-pointer border p-2 border-black my-1 rounded-xl`}
          >{`${address.name}, ${address.address_1}, ${address.address_2}, ${address.city}, ${address.state}-${address.pin_code}, ${address.telephone}`}</div>
        ))}
        <button
